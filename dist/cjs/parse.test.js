...
const parse_js_1 = __importStar(require("./parse.js"));
describe('parse', () => {
    describe('convertStylesheet', () => {
      ...
      pre {
        ...
        padding: 10px;
            ...
            const result = (0, parse_js_1.convertStylesheet)(content);
            const expected = {
                '.my-heading4': {
    ...
    describe('convertElementStyle', () => {
        it('Should convert element CSS into HtmlStyle', () => {
            ...
            const result = (0, parse_js_1.convertElementStyle)(content, 'div');
            const expected = {
                backgroundColor: 'darkgreen',
                bogus: 'nope',
                color: 'white',
...
<p>
    <ul>
      ...
      `;
            const result = (0, parse_js_1.default)(content);
