...
import renderHtml, { bucketElements, collapseWhitespace, hasBlockContent, } from './render.js';
const scrub = (object) => {
...
import { Text, View, Page, Document, Font, renderToString, } from '@react-pdf/renderer';
import * as path from 'path';
import renderers, { renderBlock, renderCell, renderNoop, renderPassThrough, } from './renderers.js';
  ...
  <body>
    <div></div>
        ...
        it('Should render keep spaces around custom elements', () => {
            ...
            const rootView = renderHtml(html, {
                renderers: {
                    customelement: () => React.createElement(View, null),
                },
            });
